 ...
 */
public class ChangeTenantPassword extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ChangeTenantPassword
     */
    public ChangeTenantPassword() {
        initComponents();
    }

    public ChangeTenantPassword(MyLinkedList linkedList, int activeTenant) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("SETUP YOUR NEW PASSWORD");
        ...
        warningLabel.setFont(new java.awt.Font("Century Gothic", 0, 10)); // NOI18N
        warningLabel.setForeground(new java.awt.Color(255, 153, 153));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(confirmPass, javax.swing.GroupLayout.PREFERRED_SIZE, 294, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void confirmPassMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_confirmPassMouseClicked
        if(warningLabel.getText().equals("Confirm password is incorrect!")) {
    ...
    private void newPasswordValidation() {
        ...
        if (!confirmPassword.equals(newPassword)) {
            warningLabel.setText("Confirm password is incorrect!");
        } else {
            saveNewPassword(newPassword);
            JOptionPane.showMessageDialog(null, "New password was saved successfully!");
            dispose();
        }
    }
    ...
    private void saveNewPassword(String newPassword) {
        ...
        currentNode.setPassword(newPassword);
        saveToDB();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangeTenantPassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangeTenantPassword().setVisible(true);
            }
        });
    }
