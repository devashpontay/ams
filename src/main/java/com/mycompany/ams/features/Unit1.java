...
public class Unit1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Olga Chekmaryov designed a 29 square-meter apartment with natural materials and neutral colors,");

        jLabel9.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(37, 34, 32));
        jLabel9.setText("making it an attractive blank canvas for renters. The apartment is compact but doesn't feel cramped, thanks to");

        jLabel10.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(37, 34, 32));
        jLabel10.setText("the use of implied boundaries and convenient storage spaces. The bathroom is tucked away behind a mirrored");

        jLabel11.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(37, 34, 32));
        jLabel11.setText("door, which makes the space look larger and bounces more light into the far corners of the room.");

        jLabel2.setIcon(GetFilePath.getFilePath("apartment-one-main"));

        jLabel24.setIcon(GetFilePath.getFilePath("apartment-one-sub-1"));

        jLabel4.setIcon(GetFilePath.getFilePath("apartment-one-sub-2"));

        jLabel12.setIcon(GetFilePath.getFilePath("apartment-one-sub-3"));

        jLabel13.setIcon(GetFilePath.getFilePath("apartment-one-sub-4"));

        jLabel14.setIcon(GetFilePath.getFilePath("apartment-one-rating"));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jLabel16.setIcon(GetFilePath.getFilePath("apartment-one-utilities"));

        jLabel15.setIcon(GetFilePath.getFilePath("apartment-one-pay-1"));

        jLabel20.setIcon(GetFilePath.getFilePath("apartment-one-pay-2"));
